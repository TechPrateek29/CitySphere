    ...
    <div className="space-y-8 animate-fade-in relative z-10 w-full max-w-7xl mx-auto">
      ...
      <div className="bg-white p-8 rounded-3xl shadow-lg border border-slate-100">
         <div className="flex flex-col sm:flex-row justify-between sm:items-center mb-8 gap-4">
            <h3 className="text-2xl font-bold font-outfit text-slate-900 flex items-center"><ShieldCheck className="mr-3 text-indigo-500 shrink-0"/> Staff Management Center</h3>
            <span className="text-sm font-bold text-slate-500 bg-slate-100 px-4 py-2 rounded-full w-fit">Viewing Staff Only</span>
         </div>
      ...
      <div className="bg-white rounded-[2rem] shadow-xl border border-slate-100 overflow-hidden relative">
         ...
         <div className="p-6 md:p-8 flex flex-col sm:flex-row justify-between sm:items-center border-b border-slate-50 gap-4">
            <div>
               <h3 className="text-xl md:text-2xl font-extrabold font-outfit text-slate-900 flex items-center"><div className="p-2 bg-emerald-100 rounded-xl mr-3 shadow-sm shrink-0"><CreditCard size={24} className="text-emerald-600"/></div> Recent Bills Issued</h3>
               <p className="text-slate-500 text-sm mt-2 font-medium">Live monitoring of municipal invoices generated by Field Staff</p>
            </div>
            <span className="text-xs font-extrabold text-emerald-600 bg-emerald-50 border border-emerald-100 px-4 py-2 rounded-xl tracking-wider uppercase shadow-sm w-fit">Top 5 Records</span>
         </div>
